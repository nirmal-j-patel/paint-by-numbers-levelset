...
vtkStandardNewMacro(vtkCustomInteractorStyleRubberBand2D);

//--------------------------------------------------------------------------
vtkCustomInteractorStyleRubberBand2D::vtkCustomInteractorStyleRubberBand2D()
{
...
//--------------------------------------------------------------------------
void vtkCustomInteractorStyleRubberBand2D::OnLeftButtonDown()
{
...
//--------------------------------------------------------------------------
void vtkCustomInteractorStyleRubberBand2D::OnLeftButtonUp()
{
...
//--------------------------------------------------------------------------
void vtkCustomInteractorStyleRubberBand2D::OnMiddleButtonDown()
{
    if(this->Interaction == NONE)
    {
        this->Interaction = PANNING;
...
//--------------------------------------------------------------------------
void vtkCustomInteractorStyleRubberBand2D::OnMiddleButtonUp()
{
...
//--------------------------------------------------------------------------
void vtkCustomInteractorStyleRubberBand2D::OnRightButtonDown()
{
#if 0
    if(this->Interaction == NONE)
    {
...
//--------------------------------------------------------------------------
void vtkCustomInteractorStyleRubberBand2D::OnRightButtonUp()
{
#if 0
...
//--------------------------------------------------------------------------
void vtkCustomInteractorStyleRubberBand2D::OnMouseMove()
{
    if (this->Interaction == PANNING || this->Interaction == ZOOMING)
    {
        ...
        if (this->Interaction == PANNING)
        {
            ...
            delta[1] = lastScale*(curPt[1] - lastPt[1]); // remove minus sign to reverse the y direction
            delta[2] = 0;
...
//--------------------------------------------------------------------------
void vtkCustomInteractorStyleRubberBand2D::OnMouseWheelForward()
{
#if 0
    this->FindPokedRenderer(
        this->Interactor->GetEventPosition()[0],
...
//--------------------------------------------------------------------------
void vtkCustomInteractorStyleRubberBand2D::OnMouseWheelBackward()
{
#if 0
    this->FindPokedRenderer(
        this->Interactor->GetEventPosition()[0],
...
//--------------------------------------------------------------------------
void vtkCustomInteractorStyleRubberBand2D::RedrawRubberBand()
{
...
//--------------------------------------------------------------------------
void vtkCustomInteractorStyleRubberBand2D::PrintSelf(ostream& os, vtkIndent indent)
{
